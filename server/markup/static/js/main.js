...
var _slickCarousel = _interopRequireDefault(__webpack_require__(14));

var _jquery = _interopRequireDefault(__webpack_require__(4));

var teamMembersConfig = {
  arrows: true,
...
var reviewsConfig = {
  arrows: true,
  prevArrow: (0, _jquery["default"])('.reviews-controls__prev'),
  nextArrow: (0, _jquery["default"])('.reviews-controls__next'),
  dots: false,
  slidesToShow: 1,
  slidesToScroll: 1,
  mobileFirst: true
...
var sponsorsConfig = {
  ...
  responsive: [{
    ...
    settings: {
      arrows: true,
      prevArrow: (0, _jquery["default"])('.sponsors-prev'),
      nextArrow: (0, _jquery["default"])('.sponsors-next'),
      slidesToShow: 4
    }
  }]
};
(0, _jquery["default"])('.team-members-slider').slick(teamMembersConfig);
(0, _jquery["default"])('.reviews-slider').slick(reviewsConfig);
(0, _jquery["default"])('.sponsors-slider').slick(sponsorsConfig);
...
var _jsFormValidator = __webpack_require__(20);
